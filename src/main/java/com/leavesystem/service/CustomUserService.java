...
import com.leavesystem.exception.ResourceNotFoundException;
import com.leavesystem.mapper.UserMapper;
import com.leavesystem.model.User;
import com.leavesystem.repository.UserDetailsRepository;
...
public class CustomUserService implements UserDetailsService{
	...
	public List<UserDto> getBySupervisor(String supervisor){
		List<User>dtos = userdetailrepository.findBySupervisor(supervisor);
		return mapper.toUserDtos(dtos);
	}
